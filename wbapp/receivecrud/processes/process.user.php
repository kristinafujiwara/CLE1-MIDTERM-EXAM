...
function create_new_user(){
    ...
    if($result){
        ...
        header('location: ../index.php?page=employee&subpage=users&action=profile&id='.$id);
    }
}
...
function update_user(){
    ...
    if($result){
        header('location: ../index.php?page=employee&subpage=users&action=profile&id='.$user_id);
    }
}
